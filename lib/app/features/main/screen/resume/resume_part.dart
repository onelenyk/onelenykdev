...
import "package:onelenykdev/app/features/main/screen/resume/pdf_generator.dart";
...
class _ResumePartState
  ...
  Widget desktopScreenShotLayout(final ResumeState state) => Screenshot(
...
class _Part1WidgetState extends State<Part1Widget>
  ...
  Widget buildPartLanguages({required final String item}) => Text(
        item,
        style: GoogleFonts.roboto(
          fontSize: 14,
          color: Colors.white,
