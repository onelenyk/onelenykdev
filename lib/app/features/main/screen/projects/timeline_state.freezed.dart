...
class _$TimelineStateImpl extends _TimelineState {
  _$TimelineStateImpl({required this.reversed}) : super._();
  ...
  @override
  String toString() {
    return 'TimelineState(reversed: $reversed)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, reversed);
...
abstract class _TimelineState extends TimelineState {
  factory _TimelineState({required final bool reversed}) = _$TimelineStateImpl;
